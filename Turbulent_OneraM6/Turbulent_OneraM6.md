...
The resources for this tutorial can be found in the Tutorials/Turbulent_OneraM6 directory. You will need the configuration file ([turb_ONERAM6.cfg](turb_ONERAM6.cfg)) and the mesh file ([mesh_ONERAM6_turb_hexa_43008.su2](mesh_ONERAM6_turb_hexa_43008.su2)).
