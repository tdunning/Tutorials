...
The resources for this tutorial can be found in the [Inviscid_Wedge](https://github.com/su2code/Tutorials/tree/master/Inviscid_Wedge) directory in the [tutorials repository](https://github.com/su2code/Tutorials/tree/master/). You will need the configuration file ([inv_wedge_HLLC.cfg](inv_wedge_HLLC.cfg)) and the mesh file ([mesh_wedge_inv.cgns](mesh_wedge_inv.cgns)).
