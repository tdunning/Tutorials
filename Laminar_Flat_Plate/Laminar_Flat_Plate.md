...
The resources for this tutorial can be found in the [Laminar_Flat_Plate](https://github.com/su2code/Tutorials/tree/master/Laminar_Flat_Plate) directory in the [tutorial repository](https://github.com/su2code/Tutorials/tree/master/). You will need the configuration file ([lam_flatplate.cfg](lam_flatplate.cfg)) and the mesh file ([mesh_flatplate_65x65.su2](mesh_flatplate_65x65.su2)).
