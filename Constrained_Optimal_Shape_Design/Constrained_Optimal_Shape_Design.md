...
The resources for this tutorial can be found in the directory [Constrained_Optimal_Shape_Design](https://github.com/su2code/Tutorials/tree/master/Constrained_Optimal_Shape_Design) in the [tutorials repository](https://github.com/su2code/Tutorials/tree/master/). You will need the configuration file ([inv_ONERAM6_adv.cfg](inv_ONERAM6_adv.cfg)) and the mesh file ([mesh_ONERAM6_inv_FFD.su2](mesh_ONERAM6_inv_FFD.su2)).
